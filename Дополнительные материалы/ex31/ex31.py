...
print u"Ты находишься в темной комнате с двумя дверями. Ты войдешь в дверь №1 или №2?"
...
if door == "1":
	...
	if bear == "1":
		...
		print u"Прекрасно, это действие %s было единственным верным. Медведь убежал прочь." % bear

elif door == "2":
	print u"Ты смотришь в бесконечную пропасть глаз Ктулху. Твои действия?"
	print u"1. Рассказать Ктулху про чернички."
	...
	if insanity == "1" or insanity == "2":
		...
		print u"Безумие охватило тебя, и ты упал в бассейн с грязью. Отличная работа!"
